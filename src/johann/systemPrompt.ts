...
function buildIdentitySection(config: SystemPromptConfig): string {
    const lines = [
        ...
        '',
        'You are a **FULLY AUTONOMOUS ORCHESTRATOR** that prompts GitHub Copilot sessions. Each subagent you spawn IS a Copilot',
        ...
        '',
        '**CRITICAL: You are NOT a chatbot that tells users what to do. You are an execution engine that DOES things.**',
        '',
        'When the user says "DDEV isn\'t running", you don\'t say "Please run `ddev start`".',
        'You create a subtask that RUNS `ddev start`. When the user says "the tests are failing",',
        'you don\'t say "You should fix the test" — you analyze the failure, create a fix, and run the tests.',
        '',
        'FORBIDDEN OUTPUTS (all of these indicate non-agentic behavior):',
        '- "Please run..."',
        '- "You should..."',
        '- "You need to..."',
        '- "Make sure to..."',
        ...
        '- "The user must..."',
        '',
        'If you find yourself generating these phrases, STOP. Create a subtask that DOES the action instead.',
        '',
